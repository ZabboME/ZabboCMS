...
<html class="no-js?<?php echo time() ?>" lang="en">
	<head>
		<title>{shortname} ~ VPN Detected!</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title" content="{shortname} ~ VPN Detected!">
		...
		<meta name="twitter:title" content="{shortname} ~ VPN Detected!">
		...
		<meta itemprop="name" content="{shortname} ~ VPN Detected!">
		...
		<div class='uk-width1-1@s uk-width-1-3@m'>
			<center class='uk-margin'>
			 ...
			 <div class='habbo uk-card uk-card-default uk-card-body'>
				 <h3 class='uk-card-title chocolate__title__rainbow '><b>Hey {username}, VPN has been detected!</b></h3>
					  <div class='uk-margin'>
						  <div class='uk-inline'>
						  <p>We have detected you're using a <b>VPN/Proxy</b>, to enter the client please disable this and try again!</p>
				...
				<p class='habbo habbo-extra' style='width: auto;'>
						<span uk-icon='icon: question'>  </span> VPN Detected? Click <a href="{discord}"><b>here</b></a> to join our Discord!
					</p>
					<p class='habbo habbo-extra' style='width: auto;'>
						<span uk-icon='icon: question'>  </span> Got whitelisted? Click <a href="{url}/client"><b>here</b></a> to access the client!
					</p>
		  ...
		  <div class='uk-width-1-2@m uk-visible@m'>
              <div class="uk-margin habbo habbo-opaque uk-card uk-card-default uk-card-body" style='padding-top: 35px; padding-bottom: 35px;margin-top: 115px'>
				...
				<dd>If you report this to one of our staff members within the Discord server. You will be able the have your account added to our whitelist to prevent you being blocked from accessing Zabbo's client due to using a VPN in the future.</dd>
			  </dl>
		  </div>
		</div>
		</div>
