...
<html class="no-js?<?php echo time() ?>" lang="en">
	<head>
		<title>{shortname} ~ 404 Error!</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title" content="{shortname} ~ 404 Error!">
		...
		<meta name="twitter:title" content="{shortname} ~ 404 Error!">
		...
		<meta itemprop="name" content="{shortname} ~ 404 Error!">
		...
		<div class='uk-width1-1@s uk-width-1-3@m'>
			<center class='uk-margin'>
			 ...
			 <div class='habbo uk-card uk-card-default uk-card-body'>
				 <h3 class='uk-card-title chocolate__title__rainbow '><b>Hey There, This page doesn't exist!</b></h3>
					  <div class='uk-margin'>
						  <div class='uk-inline'>
		  ...
		  <div class='uk-width-1-2@m uk-visible@m'>
              <div class="uk-margin habbo habbo-opaque uk-card uk-card-default uk-card-body" style='padding-top: 35px; padding-bottom: 35px;margin-top: 115px'>
				...
				<dt><span uk-icon='icon: lifesaver'></span> <b>Sorry, but we can't find the page you requested.</b></dt>
				<dd>Please try typing the URL again. If you end up back here, please use the 'Here' button to get back to where you started.</dd>
			  </dl>
		  </div>
		</div>
		</div>
