...
var hh = "<br><br><form method=\"post\"><select id=\"credits\" name=\"credit_pack\"><option value=\"1\">10,000 Credits (&pound;4)</option><option value=\"2\">30,000 Credits (&pound;7)</option><option value=\"3\">50,000 Credits (&pound;10)</option></select><button type=\"submit\" name=\"credit_pack_submit\" class=\"btn btn-primary btn-block\">Buy Now</button></form>";
swal({
...
var hh = "<br><br><form method=\"post\"><select id=\"duckets\" name=\"ducket_pack\"><option value=\"1\">20,000 Duckets (&pound;4)</option><option value=\"2\">60,000 Duckets (&pound;7)</option><option value=\"3\">100,000 Duckets (&pound;10)</option></select><button type=\"submit\" name=\"ducket_pack_submit\" class=\"btn btn-primary btn-block\">Buy Now</button></form>";
swal({
...
var hh = "<br><br><form method=\"post\"><select id=\"diamonds\" name=\"diamond_pack\"><option value=\"1\">100 Diamonds (&pound;4)</option><option value=\"2\">300 Diamonds (&pound;7)</option><option value=\"3\">500 Diamonds (&pound;10)</option></select><button type=\"submit\" name=\"diamond_pack_submit\" class=\"btn btn-primary btn-block\">Buy Now</button></form>";
swal({
...
function PointsForm() {
var hh = "<br><br><form method=\"post\"><select id=\"points\" name=\"point_pack\"><option value=\"1\">1 Point (&pound;5)</option><option value=\"2\">3 Points (&pound;8)</option><option value=\"3\">5 Points (&pound;13)</option><option value=\"4\">10 Point (&pound;23)</option></select><button type=\"submit\" name=\"point_pack_submit\" class=\"btn btn-primary btn-block\">Buy Now</button></form>";
swal({
