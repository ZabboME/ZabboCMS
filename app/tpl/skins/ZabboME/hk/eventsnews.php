...
header("Location: index.php?url=eventsnews&deleteOK");
exit;
}
...
header("Location: index.php?url=eventsnews&bumpOK");
exit;
}
?>	
<!DOCTYPE html>
...
<head>
	...
	<title>ZabboASE &bull; Event News</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li>Moderation</li> <li class="active">Manage Event Articles</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Manage Event Articles</h1>
			</div>
		</div><!--/.row-->
...
<p>
	<a href="index.php?url=eventsnewspublish">
		<b>
			Write new event article
		</b>
	</a>
</p>
<br />
...
echo '<tr style="background-color: ' . $highlight . ';">
	...
	<td>
		<input type="button" class="btn btn-info btn-xs" value="View" target="_blank" onclick="document.location = \'/news/' . $n['id'] . '\';">&nbsp;
		<input type="button" class="btn btn-danger btn-xs" value="Delete" onclick="document.location = \'index.php?url=eventsnews&doDel=' . $n['id'] . '\';">&nbsp;
		<input type="button" class="btn btn-warning btn-xs" value="Edit" onclick="document.location = \'index.php?url=eventseditnews&id=' . $n['id'] . '\';">
		<input type="button" class="btn btn-success btn-xs" value="Update/bump date" onclick="document.location = \'index.php?url=eventsnews&doBump=' . $n['id'] . '\';">&nbsp;
	</td>
	</tr>';
$i++;
}
