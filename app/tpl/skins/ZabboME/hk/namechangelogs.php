...
$q     = "SELECT * FROM namechange_log WHERE ";
switch ($type) {
default:
case '1':
$q .= "user_id = '" . $query . "'";
...
<head>
	...
	<title>ZabboASE &bull; Namechange Logs</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li>Management</li> <li class="active">Namechange Logs</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Namechange Logs</h1>
			</div>
		</div><!--/.row-->
...
echo '<br /><p><a href="index.php?url=namechangelogs&doReset">Clear search</a></p><br />
...
echo '<tr>
		...
		<td>' . date("F j, Y - g:i a", $result['timestamp']) . ' (<a href="index.php?url=namechangelogs&timeSearch=' . $result['timestamp'] . '">Search</a>)</td>
		</tr>';
}
echo '</tbody>
	</thead>
...
echo '<h2>Search Namechange Logs</h2>
	<br />
	<form method="post">
	Search type:&nbsp;
	...
	<tbody>';
$getRecent = mysql_query("SELECT * FROM namechange_log ORDER BY user_id DESC LIMIT 30");
...
echo '<tr>
		...
		<td>' . $recent['new_name'] . '</td>
		<td>' . $recent['old_name'] . '</td>
		<td>' . date("F j, Y - g:i a", $recent['timestamp']) . ' (<a href="index.php?url=namechangelogs&timeSearch=' . $recent['timestamp'] . '">Search</a>)</td>
		</tr>';
}
echo '</tbody>
	</thead>
